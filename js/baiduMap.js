...
//	var ply = new BMap.Polygon(rs.boundaries[0], { strokeWeight: 1, strokeColor: "#00f",fillColor: "" });
//	map.addOverlay(ply);
	var count = rs.boundaries.length; //行政区域的点有多少个
	for(var i = 0; i < count; i++){
		var ply = new BMap.Polygon(rs.boundaries[i], {strokeWeight: 2, strokeColor: "#4A7300", fillColor: ""}); //建立多边形覆盖物
